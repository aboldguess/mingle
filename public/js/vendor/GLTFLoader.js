 ...
 * GLTFLoader.js
 * Mini README:
 * - Purpose: load glTF/GLB 3D models and associated resources.
 * - Structure: re-exports Three.js classes and utilities required to parse the format.
 * - Notes: vendor copy adapted for Mingle to work without a bundler. Imports Three.js
 *   and BufferGeometryUtils via relative paths so the admin interface can operate offline.
 */
import {
        AnimationClip,
        Bone,
